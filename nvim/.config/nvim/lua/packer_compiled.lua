...
_G.packer_plugins = {
  ...
  ["better-escape.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/sofia/.local/share/nvim/site/pack/packer/opt/better-escape.nvim",
  ...
  ["filetype.nvim"] = {
    ...
    loaded = true,
    path = "/home/sofia/.local/share/nvim/site/pack/packer/start/filetype.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-path", "cmp-buffer", "cmp_luasnip", "friendly-snippets" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'null-ls.nvim', 'gitsigns.nvim', 'nvim-treesitter', 'indent-o-matic', 'FixCursorHold.nvim', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'null-ls.nvim', 'gitsigns.nvim', 'nvim-treesitter', 'FixCursorHold.nvim', 'nvim-colorizer.lua'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
