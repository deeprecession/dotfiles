...
wifiicon.font = beautiful.iconfont .. " 12"

local ethicon = wibox.widget.textbox()
ethicon.font = beautiful.iconfont .. " 12"

local bticon = wibox.widget.textbox()
bticon.font = beautiful.iconfont .. " 12"
...
local network = wibox.widget {
        ...
        awful.spawn.with_shell('net nmtui' .. "; echo 'sb_ethernet()' | awesome-client; echo 'sb_wifi()' | awesome-client" )
      sb_ethernet()
      sb_wifi()
end))}
    ...
    if string.match(out, "Charging") then
      ...
      batperc.text = tonumber(battery) .. "%"
        ...
        elseif battery <= 30 then
            ...
            batperc.markup = "<span foreground = '" .. beautiful.yellow .. "'>".. tonumber(battery) .. "%" .."</span>"
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, }, "p", function () awful.spawn("rofi -terminal alacritty -show run -icon-theme \"Papirus\" -show-icons") end,
