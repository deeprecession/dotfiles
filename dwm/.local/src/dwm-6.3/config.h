...
static Key keys[] = {
    ...
    /* { MODKEY,			XK_p,	spawn,	SHCMD("dmenuunicode") },
     */
    ...
    {MODKEY, XK_p, spawn,
     SHCMD("rofi -terminal st -show emoji -icon-theme \" Papirus \" "
           "-show-icons")},

    {MODKEY | ShiftMask, XK_p, spawn,
     SHCMD("pkill pomodoro ; pomodoro --start")},
    ...
    {MODKEY | ShiftMask, XK_b, spawn,
     SHCMD(TERMINAL " -e lfub ~/books/cs/golang")},
    {MODKEY, XK_m, spawn, SHCMD(TERMINAL " -e ncmpcpp")},

    {MODKEY | ShiftMask, XK_n, spawn, SHCMD("mpc prev")},
    {MODKEY, XK_n, spawn, SHCMD("mpc next")},

    {MODKEY | ShiftMask, XK_n, spawn, SHCMD("mpc seek -5")},
    {MODKEY, XK_n, spawn, SHCMD("mpc seek +5")},
    ...
    {MODKEY | ShiftMask, XK_minus, spawn,
     SHCMD("temperature-redshift --dec-bright")},
    {MODKEY | ShiftMask, XK_equal, spawn,
     SHCMD("temperature-redshift --inc-bright")},

    {MODKEY | ControlMask, XK_minus, spawn,
     SHCMD("temperature-redshift --dec-temp")},
    {MODKEY | ControlMask, XK_equal, spawn,
     SHCMD("temperature-redshift --inc-temp")},

    {MODKEY | ControlMask, XK_p, spawn,
     SHCMD("systemctl --user restart pipewire.service")},

    {MODKEY | ShiftMask, XK_p, spawn, SHCMD("launch_polybar")},

    {MODKEY | ControlMask | ShiftMask, XK_b, spawn,
     SHCMD(TERMINAL " bluetoothctl")},

    {MODKEY | ControlMask, XK_b, spawn, SHCMD(TERMINAL "bluetooth-connect")},
    ...
    {0, XK_Print, spawn, SHCMD("maimpick-rofi")},
